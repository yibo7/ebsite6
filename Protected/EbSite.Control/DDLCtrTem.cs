...
namespace EbSite.Control
{
	...
	/// 下拉列表控件。
	/// </summary>
    [DefaultProperty("Text"), ToolboxData("<{0}:DDLCtrTem runat=server></{0}:DDLCtrTem>")]
    public class DDLCtrTem : System.Web.UI.WebControls.DropDownList, IPostBackDataHandler
	{
		/// <summary>
		/// 构造函数
		/// </summary>
            ...
            : base()
		{
            ...
            ListItem li = new ListItem("默认模板","");

            base.Items.Add(li);

		    base.DataTextField = "title";
		    base.DataValueField = "id";
            base.DataSource = BLL.Ctrtem.TemListInstace.TemBll(0).FillCtrTempLists();
            base.DataBind();
    	}
        /// <summary>
