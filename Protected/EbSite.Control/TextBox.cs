...
namespace EbSite.Control
{
    ...
    public class TextBox : System.Web.UI.WebControls.TextBox, IUserContrlBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                base.Attributes.Add("title", HintInfo);
                base.Attributes.Add("data-toggle", "tooltip");  
            }
                //base.Attributes.Add("onclick", string.Format("TipsAutoClose(this,'{0}')", HintInfo));

            //base.Attributes.Add("onfocus", "this.className='TextBoxFocus';");
            //base.Attributes.Add("onblur", "this.className='TextBoxDefault';");
            base.OnInit(e);
        }
    ...
    //                int maxlength = int.Parse(o.ToString());
    ...
    //            this.Attributes.Add("onfocus", "this.className='TextBoxFocus';");
    //            this.Attributes.Add("onblur", "this.className='TextBoxDefault';");
    //            this.Attributes.Add("class", "TextBoxDefault");
    //        }
    //        else
    //        {
    //            if (this.Size > 0)
    ...
    //        return new StandardValuesCollection(GetRequiredFieldType());

    //    }
    //    public  ArrayList GetRequiredFieldType()
    //    {
