...
//{
//    public class cAutoHtmlHref : ILink
//    {
...
//        {
//            return string.Concat(IISPath, iId, ContentLinkRw);
//        }
...
//        {
//            return string.Concat(IISPath, p, TaglistLinkRw);
//        }
//        public override string TagsList(int p, int OrderBy)
//        {
//            return string.Concat(IISPath, p, "-", OrderBy, TaglistLinkRw);
//        }
//        public override string TagsSearchList(object id, int p)
//        {
//            return string.Concat(IISPath, id, "-", p, TagsSearchListLinkRw);
//        }
//        public override string GetClassHref(object iId, object HtmlPath, int pIndex)
//        {
//            return string.Concat(IISPath, iId, "-", pIndex, "-0", ClassLinkRw);
//        }
...
//        {
//            return string.Concat(IISPath, iId, "-", Index, "-0", ClassLinkRw);
//        }
//        public override string GetClassHref_OrderBy(int iId, int Index, int OrderBy)
//        {
//            return string.Concat(IISPath, iId, "-", Index, "-", OrderBy, ClassLinkRw);
//        }

//        public override string GetSpecialHref(int iid, int index)
//        {
//            return string.Concat(IISPath, iid, "-", index, SpecialLinkRw);
//        }
