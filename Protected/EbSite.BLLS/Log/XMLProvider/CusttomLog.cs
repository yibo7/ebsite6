...
namespace EbSite.BLL.Log.XMLProvider
{
    ...
    public class CusttomLog : ILog
	{
        ...
        private string CurrentLogsFolder
        {
            get
            {
                return LogsFolder + "\\CusttomLog" + Path.DirectorySeparatorChar;
            }
        }
        public override Entity.Logs SelectLogs(Guid id)
        {
            ...
            //    page.IP = doc.SelectSingleNode("Logs/IP").InnerText;
            return logs;
        }
        ...
        {
            string folder = CurrentLogsFolder;
