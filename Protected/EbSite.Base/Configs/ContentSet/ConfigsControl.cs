    ...
    public class ConfigsControl
    {
        ...
        private static string GetBaseConfigsPath
        {
            get
            {
                ...
                {
                    filename = HttpContext.Current.Server.MapPath("~/ConfigsFile/ContentSet.config");
                }
                else
                {
                    filename = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ConfigsFile\\ContentSet.config");
                }
