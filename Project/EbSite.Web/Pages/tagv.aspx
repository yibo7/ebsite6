<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tagv.aspx.cs" Inherits="EbSite.Web.Pages.tagv" %>
                    ...
                    <tr>
                        ...
                        <td> 
                            <select id="ty" name="ty">
                                ...
                                <option selected value="1">标签</option>
                            </select>
                        </td>
                        <td>
                            &nbsp;&nbsp;
...
<div class="stitle cbox">
	共有<%=iSearchCount%>条与"<%=KeyWord%>"相关标签
</div>
