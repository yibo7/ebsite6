<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AskRemark.aspx.cs" Inherits="EbSite.Web.Pages.AskRemark" %>
...
<body>
    ...
    <div class="content" style="background-color:#FAFAFA" >
            ...
            <div id="savepost" class="msfbtn all2pic"></div>
    ...
    <asp:Button ID="btnPl" Width="80" Height="23" BorderColor="#000"    runat="server" Text="我要留言" OnClick="btnPl_Click" />
