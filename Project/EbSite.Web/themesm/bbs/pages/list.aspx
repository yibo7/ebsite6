    ...
    <div id="page">
        <div class="cont">
            ...
            <div class="w-navigator">
                <a  <%=rpGetSubClassList.Items.Count>0?"class='selclass'":"class='selclassex'" %>><%=Model.ClassName %></a><b>|</b>
                <a class="addpost" href="<%=EbSite.Modules.BBS.ModuleCore.GetLinks.SavePostUrlMobile(Model.ID,GetSiteID) %>">发帖</a>
            </div>
            <div id="container1">
                <ul class="data-list">
                    <XS:RepeaterList ID="rpGetClassList" runat="server">
                        <ItemTemplate>
                            <li><a target="list" href="<%#HostApi.MGetContentLink(Eval("ID"),Eval("ClassId")) %>"><span >
