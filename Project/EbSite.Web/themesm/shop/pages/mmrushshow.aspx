<%@ Page Language="C#" AutoEventWireup="true"  Inherits="EbSite.Modules.Shop.ModuleCore.Pages.mmrushshow" %>
            ...
            <div id="PJianjie"  >
                ...
                <div class="pggbox">
                    <div class="radiusbox">
                        ...
                        <div class="gglist">
                            <div>
                                价格：<b id="spSalePrice">&yen;<%=ModelG.BuyPrice %></b>
                            </div>
                            <div>
                        ...
                        <div class="addtocarbox">
                            ...
                            <div class="quantity">
                                <span class="ui-number">
                                    ...
                                    <input type="number" class="num" name="quantity" id="Number1" autocomplete="off" value="1" min="1" max="1329">
                            ...
                            <div class="tab8"><li>已经有<span><%=ModelG.Buyed%> </span>人抢购</li></div>
            ...
            <div class="pggbox">
                <div class="addtocarbox">
                    <div class="btnaddtocar">
                        <li>
                            <% if (ModelG.Status == Convert.ToInt32(EbSite.Modules.Shop.ModuleCore.SystemEnum.PanicBuyingState.正在进行中))
                               { %>
                            <input type="button" onclick="addtoshoppingcar('<%=ShopLinkApi.MShoppingPanicBuyUrl(GetSiteID,Model.ID,ModelG.id)%>')" value="加入购物车" />
                            <% }
                               else
                               { %>
