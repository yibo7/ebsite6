var editor = null;
function CompleteCss(objID, textmode, IslineNumbers, themename) {
  ...
  function forEach(arr, f) {
   ...
   editor = CodeMirror.fromTextArea(document.getElementById(objID), {
      theme:themename,
	  mode:textmode,
  ...
  var keywords = ("width height onclick style class break case catch continue debugger default delete do else false finally for function " +
