...
{
    public partial class UseCoupons : UserControlListBase
    {
        ...
        {
            //SentCount>0 and EndDateTime>now() 标记 1 代替
            return BLL.Coupons.Instance.GetListPages(pcPage.PageIndex, iPageSize, "1", "", out iCount);
        }
        /// <summary>
        /// 重写简单查询条件
        /// </summary>
        ...
        {
           // ModuleCore.BLL.Coupons.Instance.Delete(int.Parse(iID.ToString()));
        }
        #region  工具栏的初始化
