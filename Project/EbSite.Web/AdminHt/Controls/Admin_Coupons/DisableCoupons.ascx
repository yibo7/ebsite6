<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisableCoupons.ascx.cs"
    Inherits="EbSite.Web.AdminHt.Controls.Admin_Coupons.DisableCoupons" %>
    ...
    <div class="col-sm-12 col-md-12 ">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                  <XS:EasyuiDialog ID="wbShow" IsFull="true"  Title="详细内容" Text="详细内容" runat="server" />
