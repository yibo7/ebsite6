<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UseCoupons.ascx.cs"
    Inherits="EbSite.Web.AdminHt.Controls.Admin_Coupons.UseCoupons" %>
                ...
                <XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID">
                    <Columns>
                        <asp:TemplateField HeaderText="序号" ItemStyle-Width="50" ItemStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <div style="text-align: center;">
                                    <%# (this.pcPage.PageIndex-1) * this.pcPage.PageSize + Container.DataItemIndex + 1%>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <XS:EasyuiDialog ID="wbShow" Title="详细内容" Text="详细内容" IsFull="true" runat="server" />
