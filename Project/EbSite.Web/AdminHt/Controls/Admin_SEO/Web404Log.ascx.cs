...
{
    public partial class Web404Log : UserControlListBase
    {
        ...
        override protected object LoadList(out int iCount)
        {
            ...
            return BLL.Web040Log.GetListPages(pcPage.PageIndex, pcPage.PageSize, out iCount);
        ...
        override protected void BindToolBar()
        {
            ...
            ucToolBar.AddBnt("清空所有日志", string.Concat(IISPath, "images/Menus/ie.png"), "clearlog", "确认要清空所有所有404访问日志吗？");
