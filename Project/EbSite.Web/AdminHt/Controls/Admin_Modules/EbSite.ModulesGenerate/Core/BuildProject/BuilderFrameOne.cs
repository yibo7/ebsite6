    ...
    public class BuilderFrameOne : BuilderFrame
    {
        ...
        private string CreatExistsSQL()
        {
            ...
            if (Keys.Count > 0)
            {
                ...
                strclass.AppendSpaceLine(0, " where " + CodeCommon.GetWhereExpression(Keys) + " );");
        ...
        private string CreatUpdateSQL()
        {
            ...
            strclass.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetWhereExpression(Keys) + "\");");
        ...
        private string CreatDeleteSQL()
        {
            ...
            strclass.Append(Space(2) + "/// </summary>" + "\r\n");
            strclass.Append(Space(2) + "public void Delete(" + CodeCommon.GetInParameter(Keys) + ")" + "\r\n");
            strclass.Append(Space(2) + "{" + "\r\n");
            strclass.Append(Space(3) + "StringBuilder strSql=new StringBuilder();" + "\r\n");
            //if (_dbtype != "OleDb")
            //{
            ...
            //}
            if (CodeCommon.GetWhereExpression(Keys).Length > 0)
            {
                strclass.Append(Space(3) + "strSql.Append(\" where " + CodeCommon.GetWhereExpression(Keys) + ");" + "\r\n");
            }
            else
            {
        ...
        private string CreatConstructorSQL()
        {
            ...
            strclass.Append(Space(2) + "/// </summary>" + "\r\n");
            strclass.Append(Space(2) + "public " + ModelName + "(" + CodeCommon.GetInParameter(Keys) + ")" + "\r\n");
            strclass.Append(Space(2) + "{" + "\r\n");
            strclass.Append(Space(3) + "StringBuilder strSql=new StringBuilder();" + "\r\n");
        ...
        private string CreatGetModelSQL()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public void GetModel(" + CodeCommon.GetInParameter(Keys) + ")");
            strclass.AppendSpaceLine(2, "{" + "\r\n");
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            //strclass.Append(Space(3) + "strSql.Append(\"select " + " \");" + "\r\n");
            //strclass.Append(Space(3) + "strSql.Append(\"" + Fieldstrlist + " \");" + "\r\n");
        ...
        private string CreatDeleteProc()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public void Delete(" + CodeCommon.GetInParameter(Keys) + ")");
            strclass.AppendSpaceLine(2, "{" + "\r\n");
            strclass.AppendSpaceLine(3, "int rowsAffected;");
        ...
        private string CreatConstructorProc()
        {
            ...
            strclass.AppendSpaceLine(2, "/// 得到一个对象实体");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public " + ModelName + "(" + CodeCommon.GetInParameter(Keys) + ")");
            strclass.AppendSpaceLine(2, "{");
