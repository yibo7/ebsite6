...
namespace EbSite.ModulesGenerate.Core.CodeBuild
{
    ...
    public class BuilderFrame
    {
        ...
        private string _namespace = "EbSite";//顶级命名空间名
        ...
        public string Modelpath
        {
            ...
            get
            {
                _modelpath = _namespace + ".ModuleCore." + "Entity";
                if (_folder.Trim() != "")
                {
                    _modelpath += "." + _folder;
                }
        ...
        public string DALpath
        {
            get
            {
                ...
                else if (Equals(_dbtype, "OleDb"))
                {
                    strdbtype = "Access"; 
                }
                _dalpath = _namespace + ".ModuleCore.DAL." + strdbtype;
                if (_folder.Trim() != "")
                {
                    _dalpath += "." + _folder;
                }
        ...
        public string IDALpath
        {
            get
            {
                _idalpath = _namespace + ".ModuleCore." + "IDAL";
                if (_folder.Trim() != "")
                {
                    _idalpath += "." + _folder;
                }
        ...
        public string BLLpath
        {
            ...
            get
            {
                string bllpath = _namespace + ".ModuleCore." + "BLL";
                if (_folder.Trim() != "")
                {
                    bllpath += "." + _folder;
                }
