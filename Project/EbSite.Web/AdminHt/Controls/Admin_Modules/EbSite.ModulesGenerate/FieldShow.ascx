<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FieldShow.ascx.cs" Inherits="EbSite.ModulesGenerate.FieldShow" %>
<%@ Register Assembly="EbSite.Control" Namespace="EbSite.Control" TagPrefix="XS" %>
<div id="PagesMain">
<XS:Warning ID="Notes"  Text="请注意：这里查看的模块列表，不能选择主键【id】！"  runat="server"></XS:Warning>
