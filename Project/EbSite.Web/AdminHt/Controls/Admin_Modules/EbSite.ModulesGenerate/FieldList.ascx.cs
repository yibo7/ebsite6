...
{
    public partial class FieldList : EbSite.Base.ControlPage.UserControlBase
    {
        ...
        protected bool GetCheckColum(string columName)
        {
            ...
            List<FieldInfo> lsit = System.Web.HttpContext.Current.Session["FieldList"] as List<FieldInfo>;
        ...
        protected void bntOK_Click(object sender, EventArgs e)
        {
            ...
            if (!Equals(Session["FieldList"], null))
            {
               
                lsitALL = Session["FieldList"] as List<FieldInfo>;
                ...
                foreach (GridViewRow row in gdList.Rows)
                {
                    ...
                    if (cb != null && cb.Checked)
                    {
                        ...
                        model.TypeId = 1; //1:List 2:Add 3:Show 4：Search
