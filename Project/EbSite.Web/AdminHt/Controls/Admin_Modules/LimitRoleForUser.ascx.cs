...
{
    public partial class LimitRoleForUser : BaseList
    {
        ...
        {
            iCount = 0;
            BLL.ModulesBll.LimitsForUser bll = new LimitsForUser(base.GetModuleID);
        ...
        private BLL.ModulesBll.LimitRole<int> bllLimitRole
        {
            get
            {
                return new BLL.ModulesBll.LimitRoleForUser(base.GetModuleID);
            }
        }
