...
<div class="row m-t-15">
    <div class="col-lg-12">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="Admin_Modules.aspx?t=1&mid=<%=GetModuleID %>">
                    ...
                    <XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" OnRowCommand="gdList_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <a class="AdminLinkButton" data-code='<%#MakeCoder(Eval("ParentID").ToString(), Eval("ID").ToString())%>'>链接代码</a>
