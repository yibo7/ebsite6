...
<div class="row m-t-15">
    <div class="col-lg-12">
        <ul class="nav nav-tabs">
            ...
            <li class="tab">
                <a href="Admin_Modules.aspx?t=22&mid=<%=GetModuleID %>" >
                    <span class="visible-xs"><i class="fa fa-user"></i></span>
 ...
 <asp:TemplateField HeaderText="序号"  ItemStyle-Width="50"  ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" >
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                 ...
                 <XS:EasyuiDialog ID="WinBox8" SaveText="保存菜单配置" Width="500" runat="server" Href='<%# string.Concat("?t=14&id=",Eval("id"),"&mid=",GetModuleID,"&ctrPath=",Eval("FileName"))%>'
