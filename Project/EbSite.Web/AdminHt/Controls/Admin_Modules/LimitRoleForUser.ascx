<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LimitRoleForUser.ascx.cs" Inherits="EbSite.Web.AdminHt.Controls.Admin_Modules.LimitRoleForUser" %>
<%@ Register Assembly="EbSite.Control" Namespace="EbSite.Control" TagPrefix="XS" %>
<div class="row m-t-15">
    <div class="col-sm-12">
        <div class="card-box">
            <h4 class="m-t-0 m-b-20 header-title"><b>正在给<span style=" color:red"> <%=Name %></span> 设置访问权限</b></h4>
