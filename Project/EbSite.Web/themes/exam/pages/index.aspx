...
<div style="margin-top: 10px;" class="contentbox">
    ...
    <div style="width: 760px;" class="fLeft">
            ...
            <div class="clear"></div>
           <div class="indexad760">
               <XS:Widget ID="Widget8" WidgetName="首页广告-680-90"  WidgetID="e54759d9-ad7c-4950-93c6-61f55979f0fa" runat="server"/>
                                               
           </div>
           <XSD:RepeaterIndex ID="rpGetClassList" ClassIDs="12980,12981,12982"  DataType="分类列表"  runat="server">
                    <ItemTemplate>   
                                <div class="indexclassbox">
                                   ...
                                   <div class="datalist">
                                         <asp:Repeater ID="rpContent" runat="server">
                                            <ItemTemplate>
                                                 <li><a href="<%#HostApi.GetContentLink(Eval("id"),Eval("HtmlName"),GetSiteID) %>"> <%#Eval("NewsTitle")%></a></li>               
                                            </ItemTemplate>
                                        </asp:Repeater>           
