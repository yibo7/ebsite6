<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="widget.ascx.cs" Inherits="EbSite.Widgets.ClassListSite.widget" %>
<asp:Repeater ID="rpSubClass" runat="server" EnableViewState="False">
    <ItemTemplate>
        ...
        <li><a <%#(string.IsNullOrEmpty(Eval("OutLike").ToString()))?"":"target=_blank" %>
            ...
            class="<%#GetCurrentClass(Eval("ID"),"menucurrent")%>"><span>
