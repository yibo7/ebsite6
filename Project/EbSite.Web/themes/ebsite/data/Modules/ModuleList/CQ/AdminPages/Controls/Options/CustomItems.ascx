<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomItems.ascx.cs" Inherits="EbSite.Modules.CQ.AdminPages.Controls.Options.CustomItems" %>
    ...
    <XS:GridView ID="gdList" runat="server" DataKeyNames="ID" >
        <Columns>        
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                <a href="<%=GetUrl %>&pid=<%#Eval("ID")%>">查看子选项</a>
                <a href="<%= string.Concat(GetUrl,"&",AddUrl) %>&pid=<%#Eval("ID")%>">添加子选项</a>
