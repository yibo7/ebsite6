...
{
    public partial class MsgList : MPUCBaseList
    {
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("9256aed5-4799-4a6c-be71-96a2647bfcd4");
            }
        }
        ...
        protected override string GetSplitPagePram
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        strWhere = string.Format(Request.Params["u"]);
                    }
                    else
                    {
                        strWhere = base.UserName;
                    }
                    str = string.Format("mid,{0}|muid,{1}|u,{2}", base.Request["mid"], base.Request["muid"], strWhere);
                }
        ...
        override protected object LoadList(out int iCount)
        {
            ...
            List<BLL.Msg> ls = EbSite.BLL.Msg.GetListPages(pcPage.PageIndex, pcPage.PageSize, int.Parse(Request.Params["u"]), true, "id", out iCount);
