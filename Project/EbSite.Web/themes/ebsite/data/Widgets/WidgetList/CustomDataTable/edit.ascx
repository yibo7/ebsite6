...
数据模板:<XS:ExtensionsCtrls ID="drpTemList" ModelCtrlID="bdec2947-cc6b-4e9a-abf2-56cb7d77387e" runat="server" />
<br />
...
<div id="tagsdiv1" name="tbSetConfigs">
    <table id="tbSetConfigs">
        ...
        <tr>
            <td colspan="2">数据表字段设置:<br>
                注,每行表示一列的配置，格式为：字段展示名称|字段调用名称|控件ID|是否只读（可选）</td>
        </tr>
        <tr>
            <td colspan="2">
