<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="edit.ascx.cs" Inherits="EbSite.Modules.Wenda.Widgets.GetSolve.edit" %>
<%@ Register Assembly="EbSite.Control" Namespace="EbSite.Control" TagPrefix="XS" %>
 ...
 选择分类:<XS:DropDownList ID="drpClass" AppendDataBoundItems="true" runat="server">
         ...
         调用类别:<XS:DropDownList ID="drpType" runat="server">
            <asp:ListItem Value="1" Text="赏金求答案列表"></asp:ListItem>
            <asp:ListItem Value="2" Text="已解决问题列表"></asp:ListItem>           
         </XS:DropDownList>
         <br /><br />
         数据列表模式:
          <XS:DropDownList ID="drpListModel" runat="server">
            ...
            <asp:ListItem Value="4" Text="只列表图片"></asp:ListItem>
         </XS:DropDownList>
         
<br /><br />
是否显示序号:<asp:CheckBox ID="cbIsShowNum" runat="server" />
<br /><br />
