<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.manswertop" %>
			...
			<div class="soletr" style="width:694px;">
				...
				<div class="drlist">
					<div class="drtab1">
                        ...
                        <li class="cur2"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.AnswerTop(GetSiteID) %>">回答最多</a></li>
						        ...
						        <div class="kfleft" style="padding-left:0px; " >
						            ...
						            <div class="kfright drinfor"  >
							           ...
							           <li>积分：<span><%#Eval("Credits")%></span></li>
                                        <li>回答问题数：<span><%#Eval("acount")%></span></li>
						            </div>
					            </div>
