			...
			<table width="477" border="0" cellpadding="0" cellspacing="0" style="color:#5C5C5C; font-size:14px; margin-top:30px; margin-left:30px;">
                        <tr>
                                ...
                                <td  colspan="2" class="regtype">
                                    <label for="reg_type0"><input type="radio" value="0" checked="checked" name="reg_type"                             id="reg_type0" />Email注册</label>
                                     <label for="reg_type1"><input type="radio" value="1" name="reg_type" id="reg_type1" />帐号注册                            </label>
                                ...
                                <td width="248"><input type="text" name="reg_username" id="reg_username" value="您的帐号"                             class="inp_name" /></td>
                                <td width="151"><span id="errreg_username" style="color:#ccc; font-size:12px;"></span></td>
                                </tr>
                              <tr id="show_email">
                                <td width="78" height="58" align="right">Email：</td>
                                <td width="248"><input type="text" name="reg_email" value="您的Email地址" id="reg_email"                             class="inp_name" /></td>
                                ...
                                <td width="248"><input type="text" name="reg_mobile" value="您的手机号"  id="reg_mobile"                             class="inp_name" /></td>
                              ...
                              <tr>
                                ...
                                <td><input type="text" name="reg_yzm" id="reg_yzm" class="inp_yzm2" style="float:left" />
                                 <img class="ValidateCode" src="/ValidateCode.ashx?" onclick="this.src+=Math.random()"                               style="float:left; cursor: pointer; height:30px;" /></td>
