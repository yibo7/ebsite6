<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.mtiwen" %>
			...
			<div class="soletr" style="width:694px;">
				...
				<div class="drlist">
					<div class="drtab1">
                     ...
                     <li id="menutiwen" class="cur2"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.TiWen(GetSiteID,mdUser.id) %>">TA的提问</a></li> 
