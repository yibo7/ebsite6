<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.mexpert" %>
			...
			<div class="soletr" style="width:694px;">
				...
				<div class="drlist">
					<div class="drtab1">
                        ...
                        <li class="cur1"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.NewReg(GetSiteID) %>">最新注册</a></li>
                        <li class="cur2"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.Expert(GetSiteID) %>">专家列表</a></li>
                    </div>
                         ...
                         <ItemTemplate>
						        ...
						        <div class="kfleft" style="padding-left:0px; " >
							          <a href="<%#EbSite.Modules.Wenda.ModuleCore.GetLinks.JieDa(GetSiteID,Eval("UserID")) %>">
                                        <img  src="<%#EbSite.Base.Host.Instance.AvatarBig(int.Parse(Eval("UserID").ToString()))%>" class="wdtab2" />
                                        </a>
						            </div>
						            <div class="kfright drinfor"  >
							            ...
							            <li>简介：<%#string.IsNullOrEmpty(Eval("JianJie").ToString()) ? "<font color='#C4BEBB'>作者很忙，暂时没时间更新签名</font>" : Eval("JianJie")%></li>
