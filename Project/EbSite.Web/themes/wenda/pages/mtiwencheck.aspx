<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.mtiwencheck" %>
					...
					<div class="drtab1">
                     ...
                     <li id="menutiwen" class="cur1"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.TiWen(GetSiteID,mdUser.id) %>">TA的提问</a></li> 
                        ...
                        <li id="menujieda"  class="cur1"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.JieDa(GetSiteID,mdUser.id) %>">TA的解答</a></li>
                         <li class="cur2" id="menucheck"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.TiWenCheck(GetSiteID,mdUser.id) %>">提问审核中</a></li>
                    <li class="cur1"  id="menumyask"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.MyAsked(GetSiteID,mdUser.id) %>">向我的提问</a></li>
                    </div>
					<div class="drquelst">
