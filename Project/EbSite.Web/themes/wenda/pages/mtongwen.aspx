<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.mtongwen" %>
			...
			<div class="soletr" style="width:694px;">
					...
					<div class="drtopl">
						<div  class="drinfo" style="margin-bottom:5px;" >
							...
							<div class="kfright wdtab3" >
								<div class="niname">昵称：<%=mdUser.NiName%> <div id="sid" style=" display:none;"><%=mdUser.id%> </div></div>
								<div>积分：<span><%=mdUser.Credits%></span></div>
								<div>回答：<span><%=mdTotal.ACount%></span></div>	
				...
				<div class="drlist">
					<div class="drtab1">
                        ...
                        <li id="menutongwen" class="cur2"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.TongWen(GetSiteID,mdUser.id) %>">TA的同问</a></li>
                        <li id="menujieda" class="cur1"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.JieDa(GetSiteID,mdUser.id) %>">TA的解答</a></li>
                        <li  class="cur1" id="menucheck" style="display: none;"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.TiWenCheck(GetSiteID,mdUser.id) %>">提问审核中</a></li>
					...
					<div class="drquelst">
                     <XS:Repeater ID="rpList" runat="server">
                         <ItemTemplate>
                          ...
                          <FooterTemplate>  
                            <asp:Label ID="lbEmpty" Text="TA还没有同问过！"  style=" padding-left:30px; color:#ccc;"  runat="server" Visible='<%#bool.Parse((rpList.Items.Count==0).ToString())%>'></asp:Label>  
                          </FooterTemplate>   
