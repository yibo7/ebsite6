<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Wenda.ModuleCore.Pages.mattractive" %>
...
<!---中间开始--->
	...
	<div class="soletcen" style="margin-top:10px; ">
			...
			<div class="soletr" style="width:694px;">
				...
				<div class="drlist">
					<div class="drtab1">
                        <li class="cur2"><a href="<%=EbSite.Modules.Wenda.ModuleCore.GetLinks.Attractive(GetSiteID) %>">积分达人</a></li>
