<%@ Page Language="C#" AutoEventWireup="true" Inherits="EbSite.Modules.Shop.ModuleCore.Pages.mrushshow" %>
												...
												<div class="tuanbtn all"><li style="line-height:70px;">￥<%=ModelG.BuyPrice %></li><li class="cur"> <%= EbSite.Modules.Shop.ModuleCore.Core.GetDiscountRate(ModelG.Price,ModelG.BuyPrice) %>折</li>
                                                   <li>
                                                       <% if (ModelG.Status == Convert.ToInt32(EbSite.Modules.Shop.ModuleCore.SystemEnum.PanicBuyingState.正在进行中))
                                                          { %>
                                                           <a href="javascript:addtoshoppingcar('<%=ShopLinkApi.ShoppingPanicBuyUrl(GetSiteID,Model.ID,ModelG.id) %>')"  > <img src="<%= base.ThemeCss %>images/qianggou.jpg"/></a>
                                                       <% }
                                                          else
                                                          { %>
