<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintGHD.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Orders.HelpPage.PrintGHD" %>
...
<thead><tr><th>货号</th><th>商品</th><th>商品单价</th><th>购买数量</th><th>发货数量</th><th>小计</th></tr></thead>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style="text-align:center"><%# EbSite.Core.Utils.ObjectToInt(Eval("Quantity"),0)+EbSite.Core.Utils.ObjectToInt(Eval("GiveQuantity"),0)%></td>
...
<table class="printnocss" border="0" cellspacing="0">
    <tr>
        <th>商品金额:</th><td><asp:Literal ID="litGoodsPrice" runat="server"></asp:Literal></td>
        <th>运费:</th><td><asp:Literal ID="litYFFree" runat="server"></asp:Literal></td>
        <th>支付手续费:</th><td><asp:Literal ID="litPayFree" runat="server"></asp:Literal></td>
    </tr>
    <tr>
        <th>优惠券抵扣金额:</th><td><asp:Literal ID="litYHQPrice" runat="server"></asp:Literal></td>
        <th>买家折扣:</th><td><asp:Literal ID="litMJZK" runat="server"></asp:Literal></td>
        <th>满额打折活动:</th><td><asp:Literal ID="litMEFree" runat="server"></asp:Literal></td>
    </tr>
    <tr><th>订单选项费用:</th><td colspan="5"><asp:Literal ID="litOrderOptionFree" runat="server"></asp:Literal></td></tr>
    <tr><td colspan="4"></td><th>订单实付金额:</th><td><asp:Literal ID="litRealPrice" runat="server"></asp:Literal></td></tr>
</table>
<div class="divclear">&nbsp;</div>
