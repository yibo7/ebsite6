<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvGoodsList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.AdvGoodsList" %>
	...
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" >
		<Columns>
            ...
            <asp:TemplateField HeaderText="图片">
				<ItemTemplate>
               <img width="80" height="60" src="<%#Eval("AdPicUrl")%>" />
				</ItemTemplate>
			</asp:TemplateField>
