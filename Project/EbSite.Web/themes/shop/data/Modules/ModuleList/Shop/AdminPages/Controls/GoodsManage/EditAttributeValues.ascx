<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditAttributeValues.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.GoodsManage.EditAttributeValues" %>
