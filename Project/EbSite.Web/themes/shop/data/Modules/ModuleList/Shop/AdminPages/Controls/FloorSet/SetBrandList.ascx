<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetBrandList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.SetBrandList" %>
            ...
            <div>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left" colspan="3">
                           <XS:SWFUpload ID="UploadImg" runat="server" AllowSize="2000" AllowExt="jpg,png,gif" IsMakeSmallImg="False" AddBtnName="添加图片" SaveFolder="/themes/shop/data/Upload" />
                        </td>
                    </tr>
                </table>
            </div>
