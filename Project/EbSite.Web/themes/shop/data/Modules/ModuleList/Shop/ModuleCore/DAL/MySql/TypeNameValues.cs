...
namespace EbSite.Modules.Shop.ModuleCore.DAL.MySql
{
	...
	public partial class Shop
	{
		...
		public int TypeNameValues_Add(Entity.TypeNameValues model)
		{
			...
			MySqlParameter[] parameters = {
					new MySqlParameter("?TypeValueName", MySqlDbType.VarChar,50),
					new MySqlParameter("?OrderID", MySqlDbType.Int32,4),
					new MySqlParameter("?TValues", MySqlDbType.VarChar,100),
					new MySqlParameter("?TypeNameValueID", MySqlDbType.Int32,4),
		...
		public List<Entity.TypeNameValues> TypeNameValues_GetListPages(int PageIndex, int PageSize, string strWhere, string Fileds, string oderby,out int RecordCount)
        {
            ...
            RecordCount = TypeNameValues_GetCount(sbSql.ToString());
            List<Entity.TypeNameValues> list = new List<Entity.TypeNameValues>();
            string strSql = SplitPages.GetSplitPagesMySql(DB, "TypeNameValues", PageSize, PageIndex, Fileds, "id", oderby, sbSql.ToString(), sPre);
