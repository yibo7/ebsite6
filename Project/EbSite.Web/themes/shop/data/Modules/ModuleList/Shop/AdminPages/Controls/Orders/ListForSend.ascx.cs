...
{
    public partial class ListForSend : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("5db611f6-7984-49e1-95dc-e4fe8f1d1f65");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus="+ModuleCore.BLL.Buy_Orders.Instance.GetStatusTips(ModuleCore.SystemEnum.OrderStatus.已发货);
            }
        }
