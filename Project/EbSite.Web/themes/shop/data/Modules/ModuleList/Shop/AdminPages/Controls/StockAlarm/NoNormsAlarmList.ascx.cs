...
{
    public partial class NoNormsAlarmList : MPUCBaseList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("dba178f4-eb7a-43b3-8ce6-72d9e7c746c5");
            }
        }
        ...
        {
            return Base.AppStartInit.NewsContentInstDefault.GetListPages(pcPage.PageIndex, iPageSize, "annex22=0 and annex12<=annex13 and annex13>0", out iCount, SettingInfo.Instance.GetSiteID);
        ...
        {
            return Base.AppStartInit.NewsContentInstDefault.GetListPages(pcPage.PageIndex, iPageSize, "annex22=0 and annex12<=annex13 and annex13>0 and newstitle like '%" + ucToolBar.GetItemVal(ProductName) + "%'", out iCount, SettingInfo.Instance.GetSiteID);
