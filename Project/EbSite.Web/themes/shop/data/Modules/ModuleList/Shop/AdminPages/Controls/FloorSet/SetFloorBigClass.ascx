<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetFloorBigClass.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.SetFloorBigClass" %>
...
<div style="text-align: center">
            <XS:Button ID="bntSave" runat="server" Text=" 提交 " /> <a href="/themes/shop/data/Modules/ModuleList/Shop/AdminPages/FloorSet.aspx?muid=a4de7dee-4d12-4738-ada0-f8b27960811f&mid=cfccc599-4585-43ed-ba31-fdb50024714b&id=<%=fid %>">返回</a>
        </div>
