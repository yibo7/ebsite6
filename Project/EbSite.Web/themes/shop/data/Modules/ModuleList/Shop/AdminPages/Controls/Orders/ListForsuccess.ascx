<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListForsuccess.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Orders.ListForsuccess" %>
        ...
        <XS:Repeater ID="rpList" runat="server" >
            <HeaderTemplate>
                <tr class="GridViewHeader">
                    ...
                    <th scope="col">订单实收款(元)</th><th scope="col">订单状态</th><th>打印状态</th><th>标注</th><th>成交时间</th><th>操作</th>
            ...
            <ItemTemplate>
                <tr tid="<%# Eval("ID") %>"> 
                    ...
                    <td><a onclick="PrintOrder(this,'KDD')">快递单</a> <a onclick="PrintOrder(this,'GHD')">购</a> <a onclick="PrintOrder(this,'PSD')">配</a> <a onclick="MarkOrder(this)">标注</a></td>
