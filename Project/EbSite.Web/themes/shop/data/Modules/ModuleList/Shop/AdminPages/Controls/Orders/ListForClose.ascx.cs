...
{
    public partial class ListForClose : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("6e44c9fd-c2ea-4a42-964f-d9e8aed81f26");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus=" + ModuleCore.BLL.Buy_Orders.Instance.GetStatusTips(ModuleCore.SystemEnum.OrderStatus.回收站);
            }
        }
