...
{
    public partial class ListForsuccess : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("7981d558-83ce-4197-8e9b-5c145a8d93c4");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus=" + ModuleCore.BLL.Buy_Orders.Instance.GetStatusTips(ModuleCore.SystemEnum.OrderStatus.交易完成);
            }
        }
