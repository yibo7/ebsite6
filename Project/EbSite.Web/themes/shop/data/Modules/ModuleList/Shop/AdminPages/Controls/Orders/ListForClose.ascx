<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListForClose.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Orders.ListForClose" %>
        ...
        <XS:Repeater ID="rpList" runat="server" >
            <HeaderTemplate>
                <tr class="GridViewHeader">
                    ...
                    <th scope="col">订单实收款(元)</th><th scope="col">订单状态</th><th>原因</th>
