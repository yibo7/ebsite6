...
{
    public partial class ListForSended : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("ba1bc8c7-0714-441c-a0b1-926a040e0760");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus=" + ModuleCore.BLL.Buy_Orders.Instance.GetStatusTips(ModuleCore.SystemEnum.OrderStatus.确认收货);
            }
        }
