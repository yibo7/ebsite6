<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListForSended.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Orders.ListForSended" %>
        ...
        <XS:Repeater ID="rpList" runat="server" >
            <HeaderTemplate>
                <tr class="GridViewHeader">
                    ...
                    <th scope="col">订单实收款(元)</th><th scope="col">订单状态</th><th>打印状态</th><th>标注</th><th>收货时间</th><th>操作</th>
            ...
            <ItemTemplate>
                <tr tid="<%# Eval("ID") %>"> 
                    ...
                    <td><%#Eval("surereceiptdate")%></td>
                    <td><a onclick="FinishOrder(this)">交易完成</a> &nbsp;<a onclick="MarkOrder(this)">标注</a></td>
