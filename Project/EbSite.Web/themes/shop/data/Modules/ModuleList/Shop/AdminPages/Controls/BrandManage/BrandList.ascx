<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BrandList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.BrandManage.BrandList" %>
	...
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" >
		<Columns>
			...
			<asp:TemplateField HeaderText="Logo">
				<ItemTemplate>
				<image src="<%#Eval("Logo")%> "   height="60" width="60"/>	
				</ItemTemplate>
			</asp:TemplateField>
