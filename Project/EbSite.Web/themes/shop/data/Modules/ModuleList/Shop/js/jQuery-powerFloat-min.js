(function (a) {
    a.fn.powerFloat = function (d) {
        return a(this).each(function () {
            ...
            switch (e.eventType) {
                case "hover": a(this).hover(function () {
                    f(e, a(this));
                    var h = parseInt(e.showDelay, 10), g;
                    if (h) {
                        if (g) {
                            clearTimeout(g)
                        }
                ...
                , function () {
                    ...
                    break;
                case "click": a(this).click(function (g) {
                    if (c.flagDisplay && g.target === c.trigger.get(0)) {
                        ...
                        if (!a(document).data("mouseupBind")) {
                            a(document).bind("mouseup", function (i) {
                                var h = false;
                    ...
                    break;
                case "focus": a(this).focus(function () {
                    var g = a(this);
                    setTimeout(function () {
                        f(e, g);
                        c.targetGet()
    ...
    var c = {
        targetGet: function () {
            ...
            switch (this.s.targetMode) {
                ...
                case "ajax": var d = g || h;
                    ...
                    break;
                case "list": var k = '<ul class="float_list_ul">', j;
        ...
        , position: function () {
            ...
            var D = function (F) {
                var G = "bottom";
                switch (F) {
                    case "1-4": case "5-7": case "2-3": G = "top";
                        break;
                    case "2-1": case "6-8": case "3-4": G = "right";
                        break;
                    case "1-2": case "8-6": case "4-3": G = "left";
                        break;
                    case "4-1": case "7-5": case "3-2": G = "bottom";
                        break
                }
                return G
            };
            ...
            if (this.s.edgeAdjust) {
                if (t(j)) {
                    ...
                    (function () {
                        if (n(v)) {
                            var G = {
                                "5-7": "7-5", "7-5": "5-7", "6-8": "8-6", "8-6": "6-8"
                            };
                            v = G[v]
                        }
                        else {
            ...
            if (y && m && this.corner) {
                this.corner.css({
                    left: u, top: q, zIndex: this.s.zIndex + 1
                })
            }
            this.target.css({
                position: "absolute", left: e, top: E, zIndex: this.s.zIndex
            });
            return this
        }
    ...
    var b = {
        ...
        , zIndex: 999, eventType: "hover", showDelay: 0, hideDelay: 0, hoverHold: true, hoverFollow: false, targetMode: "common", target: null, targetAttr: "rel", container: null, reverseSharp: false, position: "4-1", edgeAdjust: true, showCall: a.noop, hideCall: a.noop
    }
