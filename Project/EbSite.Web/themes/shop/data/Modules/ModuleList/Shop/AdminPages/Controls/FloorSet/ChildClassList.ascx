<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChildClassList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.ChildClassList" %>
...
<div id="PagesMain">
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" >
		<Columns>
			...
			<asp:TemplateField HeaderText="子分类名称">
				<ItemTemplate>
					<%#Eval("smallClassName")%>
				</ItemTemplate>
			</asp:TemplateField>
