<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AlarmList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.StockAlarm.AlarmList" %>
		...
		<Columns>
			...
			<asp:TemplateField HeaderText="操作" ItemStyle-Width="130">
				<ItemTemplate>
                    ...
                    <a href="javascript:void(0);" id='<%#Eval("PNumber")%>' onclick="LookRecord(this)">进出库记录</a>
				</ItemTemplate>
			</asp:TemplateField>
