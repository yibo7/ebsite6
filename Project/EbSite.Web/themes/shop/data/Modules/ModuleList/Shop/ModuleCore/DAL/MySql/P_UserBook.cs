...
namespace EbSite.Modules.Shop.ModuleCore.DAL.MySql
{
    ...
    public partial class Shop
	{
		...
		public List<Entity.P_UserBook> P_UserBook_GetListPages(int PageIndex, int PageSize, string strWhere, string Fileds, string oderby,out int RecordCount)
		{
            ...
            RecordCount = P_UserBook_GetCount(sbSql.ToString());
            List<Entity.P_UserBook> list = new List<Entity.P_UserBook>();
            string strSql = SplitPages.GetSplitPagesMySql(DB, "P_UserBook", PageSize, PageIndex, Fileds, "id", oderby, sbSql.ToString(), sPre);
