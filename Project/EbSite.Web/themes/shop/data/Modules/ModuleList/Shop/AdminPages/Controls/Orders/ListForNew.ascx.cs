...
{
    public partial class ListForNew : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("0e9c34e2-d2e8-4678-8d5d-ff135468ac46");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus=" +base.GetOrderState(ModuleCore.SystemEnum.OrderStatus.提交订单);
            }
        }
