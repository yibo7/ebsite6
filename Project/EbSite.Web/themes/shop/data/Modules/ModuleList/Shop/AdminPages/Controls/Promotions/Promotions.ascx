<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Promotions.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Promotions.Promotions" %>
	...
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" onrowdatabound="gdList_RowDataBound" >
		<Columns>
			...
			<asp:TemplateField HeaderText="促销活动类型">
				<ItemTemplate>
					<%# EbSite.Modules.Shop.ModuleCore.BLL.PromotionsType.GetPromotionsTypeName(Eval("PromoteType").ToString())%>
				</ItemTemplate>
			</asp:TemplateField>
