<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.List" %>
		...
		<Columns>
			...
			<asp:TemplateField HeaderText="操作">
				<ItemTemplate>
                    ...
                    <a href="<%=GetPageUrl("a4de7dee-4d12-4738-ada0-f8b27960811f") %>&id=<%#Eval("id")%>">设计楼层</a>
