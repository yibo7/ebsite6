	...
	public partial class Shop
	{
		...
		public int Norms_Add(Entity.Norms model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("?NormsName", MySqlDbType.VarChar,50),
					...
					new MySqlParameter("?IsImg", MySqlDbType.Int32,4)};
		...
		public List<Entity.Norms> Norms_GetListPages(int PageIndex, int PageSize, string strWhere, string Fileds, string oderby,out int RecordCount)
		{
            ...
            RecordCount = Norms_GetCount(sbSql.ToString());
            List<Entity.Norms> list = new List<Entity.Norms>();
            string strSql = SplitPages.GetSplitPagesMySql(DB, "Norms", PageSize, PageIndex, Fileds, "id", oderby, sbSql.ToString(), sPre);
