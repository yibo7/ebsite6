<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Optimal.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.RelatedProduct.Optimal" %>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <XS:EasyuiDialog ID="wbModify" Title="修改" Text="修改/" Width="800" Height="400" IsFull="true"
                        Href='<%# string.Concat(GetUrl,"&t=1&id=",Eval("productid"))%>' runat="server" />
