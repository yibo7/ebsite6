<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetFloorChildClass.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.FloorSet.SetFloorChildClass" %>
