<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditNormsValue.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.GoodsManage.EditNormsValue" %>
	...
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" >
		<Columns>
			...
			<asp:TemplateField HeaderText="属性值">
				<ItemTemplate>
					<%#GetTitle(Eval("NormsIco").ToString(), Eval("NormsValueName").ToString())%> 
				</ItemTemplate>
			</asp:TemplateField>
