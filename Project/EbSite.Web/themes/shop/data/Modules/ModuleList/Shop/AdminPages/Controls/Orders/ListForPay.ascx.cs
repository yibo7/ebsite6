...
{
    public partial class ListForPay : BaseOrderList
    {
        ...
        public override Guid ModuleMenuID
        {
            get
            {
                return new Guid("9c9223d6-8106-41dc-9788-3063fe5f998b");
            }
        }
        ...
        public string OrderState
        {
            get
            {
                return "OrderStatus="+ModuleCore.BLL.Buy_Orders.Instance.GetStatusTips(ModuleCore.SystemEnum.OrderStatus.已支付);
            }
        }
        ...
        protected override string BulderSearchWhereAdv(bool IsValueEmpytNoSearch)
        {
            ...
            {
                sqlWhere.AppendFormat(" and RealModeName=\"{0}\"", sendName);
            }
            return sqlWhere.ToString();
        }
