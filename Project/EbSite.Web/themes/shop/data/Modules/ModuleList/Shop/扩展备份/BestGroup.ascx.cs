...
{
    public partial class BestGroup : ContentExtBase
    {
        //EB_P_RecommedParts
        ...
        {
            // 先删除
            List<ModuleCore.Entity.P_BestGroup> ls = ModuleCore.BLL.P_BestGroup.Instance.GetListArray("TypeID=1 and  ProductID=" + mdContent.ID);
