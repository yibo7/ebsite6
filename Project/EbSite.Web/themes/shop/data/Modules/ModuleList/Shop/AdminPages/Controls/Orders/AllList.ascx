<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllList.ascx.cs" Inherits="EbSite.Modules.Shop.AdminPages.Controls.Orders.AllList" %>
<%@ Register Assembly="EbSite.Control" Namespace="EbSite.Control" TagPrefix="XS" %>
<XS:ToolBar ID="ucToolBar" runat="server"></XS:ToolBar>
<style type="text/css">
    .GridView tbody tr td a{ color:Blue; text-decoration:none;font-size:12px }
</style>
<div id="PagesMain">
        ...
        <XS:Repeater ID="rpList" runat="server" >
            <HeaderTemplate>
                <tr class="GridViewHeader">
                    ...
                    <th scope="col">订单实收款(元)</th><th scope="col">订单状态</th><th>下单时间</th><th>打印订单</th><th>操作</th>
            ...
            <ItemTemplate>
                <tr tid="<%# Eval("ID") %>"> 
                    ...
                    <td>
                        <%# EbSite.Modules.Shop.ModuleCore.BLL.Buy_Orders.Instance.GetPrintStateTxt(Eval("IsPrinted"),true) %>
                    </td>
                    <td> <a onclick="MarkOrder(this)">标注</a>
                        <%# SendGoods(Eval("PaymentTypeId").ToString(), Eval("OrderStatus").ToString(),Eval("groupid"),Eval("groupbuystatus"))%>
                    </td>
...
<table class="tablestyle">
    <tr>
        <th>下单日期:</th><td><XS:DatePicker ID="dateStartAdv" runat="server" Width="80px" />—<XS:DatePicker ID="dateEndAdv" runat="server" Width="80px"  /></td>
    </tr>
</table>
<table class="tablestyle">
    <tr>
