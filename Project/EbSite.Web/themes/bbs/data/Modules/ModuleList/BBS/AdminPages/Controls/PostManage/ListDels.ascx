<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListDels.ascx.cs" Inherits="EbSite.Modules.BBS.AdminPages.Controls.PostManage.ListDels" %>
	...
	<XS:GridView ID="gdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" >
		<Columns>
			...
			<asp:TemplateField HeaderText="回帖内容">
				<ItemTemplate>
				<a target="_blank" href="<%#HostApi.GetContentLink(Eval("TopicID"),SettingInfo.Instance.GetSiteID) %>"> <%#Eval("ReplyContent")%>   </a>	
				</ItemTemplate>
			</asp:TemplateField>
			...
			<asp:TemplateField HeaderText="操作">
				<ItemTemplate>
                     ...
                     <XS:LinkButton ID="lbHY" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="HYModel" confirm="true" Text=" 还原 "></XS:LinkButton>
				</ItemTemplate>
			</asp:TemplateField>
