...
<div id="mainX">
    ...
    <table class="contentmain" cellpadding="0" cellspacing="0">
		<tr>
			...
			<b><%=Model.NewsTitle %></b>
            <span><a href='<%=HostApi.GetContentLink(UpModel.ID,UpModel.HtmlName,UpModel.ClassID) %>'>
                    上一主题
                </a> </span><span> <a href='<%=HostApi.GetContentLink(NextModel.ID,NextModel.HtmlName,NextModel.ClassID) %>'>
                    下一主题
                </a>  </span>
            </td>
        </tr>
        ...
        <tr>
        	<td class="contentmain-left">
                        ...
                        <a href="<%=HostApi.GetUserSiteUrl(Model.UserID)%>">
                            ...
                            <div>
                             注册时间 :<%=mdUser(Model.UserID).CreateDate%> <br />
            ...
            <td class="contentmain-right" >
                        ...
                        <div class="bbs-line"></div>
                         <div class="topic-ct-r-content">
                            ...
                            <div>
                                 <%if (!Equals(CPIUP, null)) {%> <a href="<%=CPIUP.Href %>"><%=CPIUP.Title %></a> <%}%>  
                                <br/>
                                    <%if (!Equals(CPINext, null)) {%> <a href="<%=CPINext.Href %>"><%=CPINext.Title %></a> <%}%>  
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="savecontent">
                                                <table>
                                                    <tr>
                                                        <td><img  src="<%=BarCodeImgUrl%>"></img></td>
                                                        <td>
                                                            <div class="t">
                                                                扫描二维码将这篇文章分享给好友
                                                            </div>
                        ...
                        <div class="postbttoolbar" >
                                <div class="topic-ct-copypic"><img src="<% =ThemeCss%>images/icons/posticon_reply.gif" /></div>
                 ...
                 <tr>
        	        <td class="contentmain-left">
                                ...
                                <div class="topic-user-pic">
                                  <a target="_blank" href="<%#EbSite.Base.Host.Instance.GetUserSiteUrl(Eval("UserID")) %>">
                                    ...
                                    注册时间 :<%#mdUser(Eval("UserID")).CreateDate%> <br />
                    ...
                    <td class="contentmain-right" >
                                ...
                                <div class="postbttoolbar" >
                                        ...
                                        <div class="topic-ct-copypic"><img src="<% =ThemeCss%>images/icons/posticon_quote.gif" /></div>
                                        <div style="margin-top: 3px; float: left; margin-right: 3px;">
