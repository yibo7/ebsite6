		...
		<ItemTemplate>
			<div class='comment'>
			   <p class='title'><span><%#Eval("dateandtime")%> 发表</span>
			     <%# bool.Parse(Eval("IsNiName").ToString()) ? "匿名网友" : EbSite.Common.GetUserHomePageHref(Eval("UserName").ToString(), Eval("UserNiName").ToString(), "_blank")%>(<%#Eval("ip") %>)
			   </p>
            ...
            <table style="width:100%; margin-left:10px;">
                ...
                <tr>
                    <td colspan="5">
                        ...
                        您好,<a target=_blank href="<%=EbSite.Common.GetUserHomePage() %>"><%=EbSite.Base.AppStartInit.UserNiName%></a>
