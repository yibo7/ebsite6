<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" EnableEventValidation="false"  Inherits="EbSite.Modules.BBS.ModuleCore.Pages.msavepost" %>
        	...
        	<td class="contentmain-right">
                ...
                <div class="savediv"> 
                    ...
                    <div style="width: 100%;" >
                     ...
                     <div  >
                         (标签，多个请用英文逗号分开，如：虚云法师,名师讲座,...)<br/>
                         <asp:TextBox id="txtTags" Width="500px" runat="server"></asp:TextBox>
                     </div>
                     <div > 
