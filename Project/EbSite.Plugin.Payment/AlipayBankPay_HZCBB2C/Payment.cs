...
namespace EbSite.Plugin.Payment.AlipayBankPay_HZCBB2C
{
    [Extension("支付宝即时到帐网银支付-杭州银行", "1.0", "<a href=\"http://www.ebsite.net\">小菜菜</a>")]
    public class Payment : IPayment
    {
       ...
       public string GetPayStr(string OrderName, string TotalPrice, string OrderNumber)
       {
           ...
           return pay.GetPayStr(agent, ConfigString.GetSingleValue("PayID"), ConfigString.GetSingleValue("ValCode"),
                                ...
                                virtualPath, this.GetType().FullName, OrderNumber, "HZCBB2C", AliPayPayType.网银支付);
       }
