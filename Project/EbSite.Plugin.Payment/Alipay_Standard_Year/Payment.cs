...
namespace EbSite.Plugin.Payment.Alipay_Standard_Year
{
     [Extension("支付宝(担保交易,单笔1.5%交易费)", "1.0", "<a href=\"http://www.ebsite.net\">小菜菜</a>")]
    public class Payment : AlipayPaymentBase
    {
        override public string aDescription
        {
            get
            {
                return "支付宝担保交易，是支付宝公司针对网上交易而特别推出的安全付款服务，其运作的实质是以支付宝为信用中介，在买家确认收到商品前，由支付宝替买卖双方暂时保管货款的一种增值服务。";
            }
        }
        /// <summary>
        /// HTML文本显示为插件的帮助配置信息
        ...
        override public string aConfigHelpHtml
        {
            get
            {
                return @"支付宝，是支付宝公司针对网上交易而特别推出的安全付款服务，其运作的实质是以支付宝为信用中介，在买家确认收到商品前，由支付宝替买卖双方暂时保管货款的一种增值服务。单笔1.5%交易费。";
            }
        }
        ...
        //    return ("<a target='_blank' href='" + pay.GetPayStr(agent, ConfigString.GetSingleValue("PayID"), ConfigString.GetSingleValue("ValCode"), ConfigString.GetSingleValue("PartnerID"), "create_partner_trade_by_buyer", OrderName, TotalPrice, virtualPath, this.GetType().FullName, OrderNumber) + "'><img alt='用支付宝支付' align='absmiddle' src='" + ConfigString.GetSingleValue("PayPicUrl") + "' border=0></a>");
        //}
        ...
        ///// 设置插件信息
        ///// </summary>
        ////  private static readonly ProviderInfo info = new ProviderInfo("支付宝(担保交易,单笔1.5%交易费)", "小菜", "1.0.0.0", "http://www.ebsite.net", "http://www.ebsite.net/Plugin/EbSite.Plugin.Payment.dll");
        ...
        //    get
        //    {
        //        return @"支付宝，是支付宝公司针对网上交易而特别推出的安全付款服务，其运作的实质是以支付宝为信用中介，在买家确认收到商品前，由支付宝替买卖双方暂时保管货款的一种增值服务。单笔1.5%交易费。<a href=""https://www.alipay.com/himalayas/practicality_customer.htm?customer_external_id=C4335329993464066118&market_type=from_agent_contract&pro_codes=6AECD60F4D75A7FB"" target=""_blank""><font color=""#ff0000""><strong>立即申请</strong></font></a>";
        //    }
        //}
