...
namespace EbSite.Plugin.Payment.AlipayBankPay_BJRCB
{
    [Extension("支付宝即时到帐网银支付-北京农村商业银行", "1.0", "<a href=\"http://www.ebsite.net\">小菜菜</a>")]
    public class Payment : IPayment
    {
       public string aDescription
        {
            get
            {
                return "无需登录支付宝，直接进入网银支付-北京农村商业银行。";
            }
        }
        /// <summary>
        /// HTML文本显示为插件的帮助配置信息
       ...
       public string GetPayStr(string OrderName, string TotalPrice, string OrderNumber)
       {
           ...
           return pay.GetPayStr(agent, ConfigString.GetSingleValue("PayID"), ConfigString.GetSingleValue("ValCode"),
                                ...
                                virtualPath, this.GetType().FullName, OrderNumber, "BJRCB", AliPayPayType.网银支付);
       }
